...
const steps = [
  {
    title: <FormattedMessage id='Setting.DownloadEmployee' />,
    ...
    return (
      <div>
        ...
        <div className='container'>
          <Headline title={<FormattedMessage id='Setting.EmployeeImport' />} />
          <Alert
            ...
            description={
              <ul>
                <li>
                  ...
                  1.<FormattedMessage id='Setting.PleaseDownloadEmployee' />
                </li>
                <li>
                  {/*2、请选择 .xlsx或 .xls文件，文件大小≤2M，每次只能导入一个文件，建议每次导入不超过1000条数据。*/}
                  2.<FormattedMessage id='Setting.PleaseSelectEmployee' />
                </li>
              </ul>
            }
          />
          ...
          {current == 0 ? (
            <div style={styles.center}>
              ...
              >
                <FormattedMessage id='Setting.DownloadEmployee' />
              </Button>
          ...
          {current == 1 ? (
            <Spin spinning={this.state.loading}>
              <div className='steps-content' style={styles.center}>
                ...
                <p style={styles.grey}>
                  <FormattedMessage id='Setting.PleaseSelectEmployee' />
                </p>
            ...
            <div className='steps-content' style={styles.center}>
              <div style={styles.center}>
                ...
                <p style={styles.grey1}>
                  You can go to the employee list to view the imported employees, or continue importing.
                </p>
              </div>
