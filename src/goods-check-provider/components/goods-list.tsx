          ...
          <Column
            ...
            render={(rowInfo) => {
              if (rowInfo.auditStatus == 0) {
                return (
                  <AuthWrapper functionName="f_goods_audit_provider">
                    <Link
                      to={`/goods-check-detail-provider/${rowInfo.goodsId}`}
                    >
                      审核
                    </Link>
                  </AuthWrapper>
                ...
                return (
                  <AuthWrapper functionName="f_goods_detail_2_provider">
                    <Link
                      to={`/goods-check-detail-provider/${rowInfo.goodsId}`}
                    >
                      查看
        ...
        return (
          <div key={`${index}_${i}`} style={styles.item}>
            <div style={{ marginLeft: 17 }}>
              ...
              />
              <AuthWrapper functionName="f_goods_sku_detail_provider">
                <Link
                  style={{ marginTop: 5, display: 'block' }}
                  to={`/goods-sku-check-detail-provider/${goods.get(
                    'goodsInfoId'
                  )}`}
                >
                  查看
