  ...
  render() {
    ...
    return (
      <Modal maskClosable={false}
             title={<FormattedMessage id='Setting.AdjustmentDepartment' />}
             visible={adjustmodalVisible}
             onCancel={() => toggleAdjustModal()}
             onOk={this._handleOk}
      >
        <Alert message='The employee will belong to the Department you set up'
               type='info' />
        <Form>
          <FormItem label={<FormattedMessage id='Setting.BelongingDepartment' />} required={true}
                    style={{ marginTop: 16 }} {...formItemLayout}>
