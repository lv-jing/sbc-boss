...
import { DataGrid, noop, Const, isSystem } from 'qmkit';
      ...
      >
        ...
        <Column
          ...
          render={(rowInfo) => {
            ...
            return (
              <div>
                <a href="javascript:void(0);" style={{ marginRight: 5 }} onClick={isSystem(() => {
                  window.open(editUrl)
                })}>
                  编辑
                </a>
                <Popconfirm
                  title="确定要复制吗?"
                  onConfirm={isSystem(() => copy(rowInfo._id))}
                >
                ...
                <Popconfirm
                  title="确定要删除吗?"
                  onConfirm={isSystem(() => deletePage(rowInfo))}
                >
                  <a href="javascript:void(0);" style={{ marginRight: 5 }}>
                    删除
                  </a>
                ...
                {includePageTypeList.get(0) === 'index' &&
                  ...
                  !rowInfo.activated && (
                    <Popconfirm
                      title="确定要设为首页吗?"
                      onConfirm={isSystem(() => onActivate(rowInfo.pageCode))}
                    >
                      <a href="#">设为首页</a>
                    </Popconfirm>
                  )}
