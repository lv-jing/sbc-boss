    ...
    this.state = {
      sortedInfo: {
        ...
        columnKey:
          ...
          // ? this._renderSortCol(this.props.relaxProps.clientSort)
          // : this._renderSortCol(this.props.relaxProps.newlySort),
          this._renderSortCol(props.relaxProps.newlySort),
        order:
          // dateType == 0 || dateType == 1
          //   ? this._renderSortType(this.props.relaxProps.clientSort)
          //   : this._renderSortType(this.props.relaxProps.newlySort)
